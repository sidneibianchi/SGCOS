...
var ClienteService = /** @class */ (function () {
    ...
    ClienteService.prototype.buscarCep = function (cep) {
        var _this = this;
        return this.http.get("https://viacep.com.br/ws/" + cep + "/json/")
            .subscribe(function (data) { return _this.resultado = _this.converterRespostaParaCep(data); });
    };
    ClienteService.prototype.converterRespostaParaCep = function (cepNaResposta) {
        this.cep.id = 0;
...
var ServicoService = /** @class */ (function () {
    ...
    ServicoService.prototype.enviaEmail = function (destinatario, servico) {
...
/* harmony import */ var _equipamentos_equipamentoedit_equipamentoedit_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./equipamentos/equipamentoedit/equipamentoedit.component */ "./src/app/equipamentos/equipamentoedit/equipamentoedit.component.ts");
/* harmony import */ var _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/dashboard/dashboard.component.ts");
/* harmony import */ var _servicos_servicos_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./servicos/servicos.component */ "./src/app/servicos/servicos.component.ts");
...
/* harmony import */ var _user_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./user/usuarios/usuarios.component */ "./src/app/user/usuarios/usuarios.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'usuarios', component: _user_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_12__["UsuariosComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] }
        ]
    },
    { path: 'clientes', component: _clientes_clientes_component__WEBPACK_IMPORTED_MODULE_3__["ClientesComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
    { path: 'equipamentos/:idCliente/edit', component: _equipamentos_equipamentos_component__WEBPACK_IMPORTED_MODULE_4__["EquipamentosComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
    { path: 'equipamentoEdit/:idEquipamento/edit', component: _equipamentos_equipamentoedit_equipamentoedit_component__WEBPACK_IMPORTED_MODULE_5__["EquipamentoeditComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
    { path: 'equipamentos', component: _equipamentos_equipamentos_component__WEBPACK_IMPORTED_MODULE_4__["EquipamentosComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
    { path: 'servicos/:idEquipamento/edit', component: _servicos_servicos_component__WEBPACK_IMPORTED_MODULE_7__["ServicosComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
    { path: 'servicos', component: _servicos_servicos_component__WEBPACK_IMPORTED_MODULE_7__["ServicosComponent"], canActivate: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]] },
...
var ClientesComponent = /** @class */ (function () {
    ...
    ClientesComponent.prototype.buscaCep = function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('cep'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
    ], ClientesComponent.prototype, "InputCep", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/equipamentos/equipamentoedit/equipamentoedit.component.css":
/*!****************************************************************************!*\
  !*** ./src/app/equipamentos/equipamentoedit/equipamentoedit.component.css ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/equipamentos/equipamentoedit/equipamentoedit.component.html":
/*!*****************************************************************************!*\
  !*** ./src/app/equipamentos/equipamentoedit/equipamentoedit.component.html ***!
  \*****************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/equipamentos/equipamentoedit/equipamentoedit.component.ts":
/*!***************************************************************************!*\
  !*** ./src/app/equipamentos/equipamentoedit/equipamentoedit.component.ts ***!
  \***************************************************************************/
/*! exports provided: EquipamentoeditComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _services_Equipamento_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../_services/Equipamento.service */ "./src/app/_services/Equipamento.service.ts");
/* harmony import */ var _services_Cliente_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_services/Cliente.service */ "./src/app/_services/Cliente.service.ts");
...
var ServicosComponent = /** @class */ (function () {
    function ServicosComponent(servicoService, equipamentoService, clienteService, modalService, fb, toastr, route, localeService) {
    ...
    ServicosComponent.prototype.enviarEmail = function (servico, detalhes, emailDest) {
    ...
    ServicosComponent.prototype.confirmeEnvio = function (template) {
        var _this = this;
    ...
    ServicosComponent.prototype.getServicosComparacao = function () {
        var _this = this;
        this.servicoService.getAllServico().subscribe(function (Servicos) {
            _this.servicosComp = Servicos;
            console.log(_this.servicosComp);
        }, function (error) {
            console.log(error);
            _this.toastr.error("Erro ao tentar carregar servi\u00E7os: " + error);
        });
    };
    ServicosComponent.prototype.getEquipamentoPorId = function (idEquipamento) {
        var _this = this;
        this.equipamentoService.getEquipamentoById(idEquipamento).subscribe(function (Equip) {
            _this.equipamento = Equip;
            console.log(_this.equipamento);
            _this.getClientePorId(_this.equipamento.clienteId);
        }, function (error) {
            console.log(error);
            _this.toastr.error("Erro ao tentar carregar equipamento: " + error);
        });
    };
    ServicosComponent.prototype.getClientePorId = function (idCliente) {
        var _this = this;
        this.clienteService.getClienteById(idCliente).subscribe(function (cli) {
            _this.cliente = cli;
            console.log(_this.cliente);
        }, function (error) {
            console.log(error);
    ...
    ServicosComponent.prototype.VerificaNrOrdem = function (nrordem, template) {
        if (nrordem === '') {
            return;
        }
        var ret = this.servicosComp.filter(function (servico) { return servico.nrOrdem.toString() === nrordem; });
        if (ret.length > 0) {
    ...
    ServicosComponent.prototype.roleName = function () {
        return sessionStorage.getItem('role');
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('nrOrdem'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
    ], ServicosComponent.prototype, "NrOrdem", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('emailDestinatario'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
    ], ServicosComponent.prototype, "EmailDestinatario", void 0);
    ServicosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_Servico_service__WEBPACK_IMPORTED_MODULE_3__["ServicoService"],
            _services_Equipamento_service__WEBPACK_IMPORTED_MODULE_7__["EquipamentoService"],
